...
n.type="file",this.options.formats?n.accept=this.options.formats.join(","):n.accept=".gpx,.kml,.geojson",n.style.display="none";var r=this.loader;return n.addEventListener("change",function(t){r.load(this.files[0]),this.value=""},!1),L.DomEvent.disableClickPropagation(s),L.DomEvent.on(s,"click",function(t){n.click(),t.preventDefault()}),o}}),L.Control.fileLayerLoad=function(t){return new L.Control.FileLayerLoad(t)};
